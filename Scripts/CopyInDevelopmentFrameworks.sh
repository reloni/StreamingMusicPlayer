...
cp -R $1/Debug-iphonesimulator/RxHttpClientJasonExtension.framework ./Dependencies/iOS
cp -R $1/Debug-iphonesimulator/RxStreamPlayer.framework ./Dependencies/iOS
exit 0